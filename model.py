...
class PopulationWeightedFusion(nn.Module):
    ...
    def forward(self, H_population):
        ...
        #H_fusion =  (H_fusion-torch.min(H_fusion))/(torch.max(H_fusion)-torch.min(H_fusion))
        return H_fusion
